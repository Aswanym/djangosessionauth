...
# CORS HEADER SETTINGS-It is used when frontend is integrated. Port on which frontend is running will specify here.
...
# frontend/backend site domain for password reset link and
...
REST_FRAMEWORK = {
    ...
    # Disable Browsable api render JSON
